...
class Player(BasePlayer):
    ...
    Q2 = models.IntegerField(
        ...
        choices=[
            ...
            [1, 'B. 電腦從所有抽球結果為 2 藍 1 紅的資料中，隨機挑出 100 筆。如果這 100 筆資料中答案罐是紅罐的比較多，本回合報酬為 168 法幣。藍罐比較多則是 128 法幣。'], 
            [2, 'C. 電腦從所有抽球結果為 2 藍 1 紅的資料中，隨機挑出 1 筆，若該筆資料答案罐是紅罐，本回合報酬為 168 法幣。藍罐則是128法幣。'],
            [3, 'D. 電腦從所有抽球結果為 2 藍 1 紅的資料中，隨機挑出 100 筆。再從這 100 筆資料中再隨機選 1 筆，若該筆資料答案罐是紅罐，本回合報酬為 168 法幣。藍罐則是128法幣。'], 
            ],
        widget=widgets.RadioSelect, )

    Q3 = models.IntegerField(
        label="3. 如果本回合您認為答案罐為紅罐的可能性為 50/100，然而在表中填答 40/100 ，如下圖。請問下列何者敘述「錯誤」？ ",
        choices=[
            [0, 'A. 您的期望報酬為168 x 50/100 + 128 x 50/100 = 148法幣。'], 
            [1, 'B. 現在的答案「40/100 」低報題幹中您認為的情況，並不是最大化期望報酬的選項。'], 
            [2, 'C. 如果您改填「50/100 」，這符合題幹中您認為的情況，您的期望報酬會比現在的高。'], 
            [3, 'D. 如果您改填「60/100」，這高報題幹中您認為的情況，您的期望報酬會比現在的高。'], 
            ],
        widget=widgets.RadioSelect, )
